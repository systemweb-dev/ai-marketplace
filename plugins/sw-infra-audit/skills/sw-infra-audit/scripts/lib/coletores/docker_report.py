"""Schema INTERNO do coletor docker (era o report.json v1 da sw-cluster-audit).

Fica aqui, ao lado do coletor, porque é a forma que o `assemble_report` produz. O
`coletar` traduz isso para o schema v2, que é o do relatório. Não mexa: o miolo da
coleta de docker depende deste formato, e ele já está coberto por testes.

Original: marcador n/a, montagem, validação, split_image."""
SCHEMA_VERSION = 1
