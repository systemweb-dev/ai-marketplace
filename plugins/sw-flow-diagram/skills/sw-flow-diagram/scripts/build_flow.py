...
ICONS = {
    "brain": '<path d="M12 6a3 3 0 0 0-5.8-1A2.7 2.7 0 0 0 4.2 9.4 2.7 2.7 0 0 0 5.6 14a2.8 2.8 0 0 0 3.2 5 3 3 0 0 0 3.2-1.5"/><path d="M12 6a3 3 0 0 1 5.8-1 2.7 2.7 0 0 1 2 4.4 2.7 2.7 0 0 1-1.4 4.6 2.8 2.8 0 0 1-3.2 5A3 3 0 0 1 12 17.5"/><path d="M12 6v11.5"/>',
    "chat": '<path d="M4.5 6.5A2.5 2.5 0 0 1 7 4h10a2.5 2.5 0 0 1 2.5 2.5v6A2.5 2.5 0 0 1 17 15h-6l-4.5 4v-4A2 2 0 0 1 4.5 13z"/><path d="M8.5 8.5h7M8.5 11.5h4"/>',
    "money": '<rect x="3" y="6" width="18" height="12" rx="2"/><circle cx="12" cy="12" r="2.6"/><path d="M6.4 12h.01M17.6 12h.01"/>',
    "truck": '<path d="M3 7.5A1.5 1.5 0 0 1 4.5 6H13v9.5H3z"/><path d="M13 10h3.6l3.4 3.4v2.1H13z"/><circle cx="7.2" cy="17.6" r="1.6"/><circle cx="16.8" cy="17.6" r="1.6"/>',
    "key": '<circle cx="8" cy="12" r="3.2"/><path d="M11.2 12H21l-2.2 2.4M16.6 12v2.4"/>',
    "flask": '<path d="M10 3.5v5.9L5.5 17A2 2 0 0 0 7.2 20h9.6a2 2 0 0 0 1.7-3L14 9.4V3.5"/><path d="M9 3.5h6M8.4 14h7.2"/>',
    "chart": '<path d="M4 4v16h16"/><path d="M8 17v-4.5M12.4 17V8.5M16.8 17v-7"/>',
    "team": '<circle cx="9" cy="9" r="3"/><path d="M3.6 19a5.4 5.4 0 0 1 10.8 0"/><path d="M16 6.6a3 3 0 0 1 0 5.8M20.4 19a5.6 5.6 0 0 0-2.6-4.3"/>',
...
CATALOG = [
    {"cat": "Cliente", "items": [
        ...
        {"label": "App Desktop", "icon": "monitor"},
        {"label": "Terminal / PDV", "icon": "monitor"},
        {"label": "Sistema externo", "icon": "external"},
        {"label": "Parceiro / SaaS", "icon": "external"},
        {"label": "Dispositivo IoT", "icon": "monitor"},
        {"label": "Chatbot", "icon": "chat"},
        {"label": "Atendente", "icon": "team"},
    ]},
    {"cat": "Rede / Edge", "items": [
        ...
        {"label": "Edge Function", "icon": "function"},
        {"label": "Proteção DDoS", "icon": "shield"},
        {"label": "Terminação TLS", "icon": "key"},
        {"label": "Bastion Host", "icon": "server"},
        {"label": "VPC / Rede privada", "icon": "cloud"},
    ]},
    {"cat": "Aplicação", "items": [
        {"label": "App Server", "icon": "server"},
        {"label": "Front-end SPA", "icon": "browser"},
        {"label": "Renderização SSR", "icon": "browser"},
        {"label": "Microserviço", "icon": "service"},
        {"label": "API", "icon": "api"},
        {"label": "API gRPC", "icon": "api"},
        {"label": "WebSocket", "icon": "api"},
        {"label": "Function", "icon": "function"},
        {"label": "Container", "icon": "container"},
        {"label": "Worker", "icon": "gear"},
        {"label": "Job em lote", "icon": "gear"},
        {"label": "Orquestrador de fluxo", "icon": "gear"},
        {"label": "Máquina de estados", "icon": "decision"},
        {"label": "Motor de regras", "icon": "decision"},
    ...
    {"cat": "Dados", "items": [
        ...
        {"label": "Banco NoSQL", "icon": "database"},
        {"label": "Banco de grafos", "icon": "database"},
        {"label": "Série temporal", "icon": "chart"},
    ...
    {"cat": "Mensageria", "items": [
        ...
        {"label": "Outbox", "icon": "queue"},
        {"label": "Retry / Backoff", "icon": "clock"},
    ]},
    {"cat": "Segurança", "items": [
        {"label": "Identity Provider", "icon": "lock"},
        {"label": "OAuth / OIDC", "icon": "lock"},
        {"label": "Secrets Manager", "icon": "key"},
        {"label": "KMS", "icon": "key"},
        {"label": "Certificado TLS", "icon": "key"},
        {"label": "MFA", "icon": "mobile"},
        {"label": "Permissões / RBAC", "icon": "shield"},
        {"label": "Antivírus", "icon": "shield"},
        {"label": "Zero Trust", "icon": "shield"},
        {"label": "Assinatura digital", "icon": "document"},
        {"label": "Anonimização", "icon": "shield"},
        {"label": "SIEM", "icon": "monitor"},
    ]},
    {"cat": "DevOps / Deploy", "items": [
        {"label": "Git Repository", "icon": "document"},
        {"label": "CI Pipeline", "icon": "gear"},
        {"label": "CD Pipeline", "icon": "gear"},
        {"label": "Build", "icon": "gear"},
        {"label": "Testes automatizados", "icon": "flask"},
        {"label": "Artifact Registry", "icon": "storage"},
        {"label": "Registro de imagens", "icon": "container"},
        {"label": "Kubernetes", "icon": "container"},
        {"label": "Serverless", "icon": "function"},
        {"label": "Infra como código", "icon": "document"},
        {"label": "Ambiente de staging", "icon": "server"},
        {"label": "Blue / Green", "icon": "decision"},
        {"label": "Canary", "icon": "decision"},
        {"label": "Rollback", "icon": "clock"},
    ]},
    {"cat": "IA / ML", "items": [
        {"label": "Modelo LLM", "icon": "brain"},
        {"label": "API de inferência", "icon": "brain"},
        {"label": "Embeddings", "icon": "brain"},
        {"label": "Pipeline RAG", "icon": "search"},
        {"label": "Feature Store", "icon": "storage"},
        {"label": "Model Registry", "icon": "storage"},
        {"label": "Treino / Fine-tuning", "icon": "flask"},
        {"label": "GPU Worker", "icon": "gear"},
        {"label": "Moderação / Guardrail", "icon": "shield"},
        {"label": "Avaliação do modelo", "icon": "chart"},
    ]},
    {"cat": "Integrações", "items": [
        {"label": "Gateway de pagamento", "icon": "money"},
        {"label": "Pix", "icon": "money"},
        {"label": "Boleto", "icon": "document"},
        {"label": "Nota fiscal", "icon": "document"},
        {"label": "Antifraude", "icon": "shield"},
        {"label": "Transportadora", "icon": "truck"},
        {"label": "CRM", "icon": "external"},
        {"label": "ERP", "icon": "external"},
        {"label": "Analytics", "icon": "chart"},
        {"label": "Maps API", "icon": "globe"},
        {"label": "Open Finance", "icon": "money"},
        {"label": "Assinatura / SaaS", "icon": "external"},
    ]},
    {"cat": "Observabilidade / Fluxo", "items": [
        ...
        {"label": "APM", "icon": "chart"},
        {"label": "Health check", "icon": "monitor"},
        {"label": "Alertas", "icon": "shield"},
        {"label": "Dashboard", "icon": "chart"},
        {"label": "Plantão / On-call", "icon": "team"},
        {"label": "Auditoria", "icon": "document"},
        {"label": "Scheduler", "icon": "clock"},
        {"label": "Decisão", "icon": "decision"},
    ]},
    {"cat": "Negócio / Processo", "items": [
        {"label": "Cliente", "icon": "user"},
        {"label": "Equipe", "icon": "team"},
        {"label": "Aprovação", "icon": "decision"},
        {"label": "Contrato", "icon": "document"},
        {"label": "Proposta", "icon": "document"},
        {"label": "Pedido", "icon": "box"},
        {"label": "Pagamento", "icon": "money"},
        {"label": "Estoque", "icon": "box"},
        {"label": "Entrega", "icon": "truck"},
        {"label": "Atendimento", "icon": "chat"},
        {"label": "Relatório", "icon": "chart"},
        {"label": "Prazo / SLA", "icon": "clock"},
    ]},
]
